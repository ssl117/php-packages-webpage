								...
								<section>
									...
									<form action="" onsubmit="return validarRecepcionEnc();" method="POST">
					                    ...
					                    <p>
					                        ...
					                        <input type="text" id="nombre_dest" name="nombre_dest" autofocus="true" class="form-control" required="true" />
					                    </p>
					                    <p>
					                    	<label>Teléfono Destinatario:</label>
					                        <input type="text" id="tel_dest" name="tel_dest" class="form-control" autofocus="true" required="true" />
					                    </p>
					                    <p>
					                        <label>Nombre Remitente:</label>
					                        <input type="text" id="nombre_remit" name="nombre_remit" autofocus="true" class="form-control" required="true" />
					                    </p>
					                    <p>
					                    	<label>Teléfono Remitente:</label>
					                        <input type="text" id="tel_remit" name="tel_remit" class="form-control" autofocus="true" required="true" />
					                    </p>
					                    <p>
					                    	<label>Código Encomienda:</label>
					                        <input type="text" id="codigo" name="codigo" class="form-control" autofocus="true" required="true" />
					                    </p>
					                    <p>
					                    	<label>Observaciones:</label>
					                        <input type="text" id="observaciones" name="observaciones" autofocus="true" class="form-control" />
					                    </p>
					                    	...
					                    	<button  type="submit" name="guardarRec" class="button">Guardar</button>
